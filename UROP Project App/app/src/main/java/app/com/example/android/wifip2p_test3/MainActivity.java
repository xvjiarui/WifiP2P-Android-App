 ...
 */
public class MainActivity extends ActionBarActivity implements ChannelListener, DeviceActionListener {
    ...
    public void disconnect() {
        ...
        manager.removeGroup(channel, new ActionListener() {
            ...
            public void onFailure(int reasonCode) {
                ...
                Toast.makeText(MainActivity.this,"Disconnect failed. Reason :"+reasonCode,Toast.LENGTH_SHORT).show();
